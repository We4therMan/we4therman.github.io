/* ALL questions MUST have the following variables:question the prompt given to the player. Does not always have to be aquestion(like a challenge), but it should be labeled as suchanswers the player's options. TODO try a different kind of input?replies the dialogue that appears after an answer is pickedanger the anger value of thequestioncorrectAnswer: whichanswersadd to the final score. MUST be an array. If none are correct the array can be empty, as such: []timeLim the player's time limit to answer thequestion If the timer runs out, it counts as an incorrect answer
*/

/* IfnextEventis none, code assumes it is equivalent to it being question */
